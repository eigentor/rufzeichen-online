...
// Add Zen Tabs styles
if (theme_get_setting('dandelion_rufzeichen_tabs')) {
...
function dandelion_rufzeichen_preprocess_node(&$vars) {
...
function dandelion_rufzeichen_preprocess_block(&$vars, $hook) {
  // Add a striping class.
 ...
 */
function dandelion_rufzeichen_breadcrumb($variables) {
  $breadcrumb = $variables['breadcrumb'];
  // Determine if we are to display the breadcrumb.
  $show_breadcrumb = theme_get_setting('dandelion_rufzeichen_breadcrumb');
  if ($show_breadcrumb == 'yes' || $show_breadcrumb == 'admin' && arg(0) == 'admin') {

    // Optionally get rid of the homepage link.
    $show_breadcrumb_home = theme_get_setting('dandelion_rufzeichen_breadcrumb_home');
    ...
    if (!empty($breadcrumb)) {
      $breadcrumb_separator = theme_get_setting('dandelion_rufzeichen_breadcrumb_separator');
      $trailing_separator = $title = '';
      if (theme_get_setting('dandelion_rufzeichen_breadcrumb_title')) {
        $item = menu_get_item();
      ...
      elseif (theme_get_setting('dandelion_rufzeichen_breadcrumb_trailing')) {
        $trailing_separator = $breadcrumb_separator;
      }
...
function dandelion_rufzeichen_menu_link(array $variables) {
  ...
  $element['#attributes']['class'][] = dandelion_rufzeichen_id_safe($element['#title']);
 ...
 */
function dandelion_rufzeichen_preprocess_menu_local_task(&$variables) {
